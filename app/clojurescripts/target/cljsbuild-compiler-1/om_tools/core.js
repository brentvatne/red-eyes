...
if(typeof om_tools.core.t16676 !== 'undefined'){
} else {

/**
* @constructor
*/
om_tools.core.t16676 = (function (get_state,owner,state_proxy,meta16677){
...
om_tools.core.t16676.prototype.cljs$core$ISwap$_swap_BANG_$arity$2 = ((function (get_state){
return (function (s,f){
var self__ = this;
var s__$1 = this;
...
om_tools.core.t16676.prototype.cljs$core$ISwap$_swap_BANG_$arity$3 = ((function (get_state){
...
om_tools.core.t16676.prototype.cljs$core$ISwap$_swap_BANG_$arity$4 = ((function (get_state){
...
om_tools.core.t16676.prototype.cljs$core$ISwap$_swap_BANG_$arity$5 = ((function (get_state){
...
om_tools.core.t16676.prototype.cljs$core$IReset$_reset_BANG_$arity$2 = ((function (get_state){
return (function (_,v){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t16676.prototype.cljs$core$IDeref$_deref$arity$1 = ((function (get_state){
return (function (_){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t16676.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (get_state){
...
om_tools.core.t16676.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (get_state){
return (function (_16678,meta16677__$1){
var self__ = this;
var _16678__$1 = this;
return (new om_tools.core.t16676(self__.get_state,self__.owner,self__.state_proxy,meta16677__$1));
});})(get_state))
;

om_tools.core.t16676.cljs$lang$type = true;

om_tools.core.t16676.cljs$lang$ctorStr = "om-tools.core/t16676";

om_tools.core.t16676.cljs$lang$ctorPrWriter = ((function (get_state){
return (function (this__4225__auto__,writer__4226__auto__,opt__4227__auto__){
return cljs.core._write.call(null,writer__4226__auto__,"om-tools.core/t16676");
});})(get_state))
;

om_tools.core.__GT_t16676 = ((function (get_state){
return (function __GT_t16676(get_state__$1,owner__$1,state_proxy__$1,meta16677){
return (new om_tools.core.t16676(get_state__$1,owner__$1,state_proxy__$1,meta16677));
});})(get_state))
;

}

return (new om_tools.core.t16676(get_state,owner,state_proxy,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),55,new cljs.core.Keyword(null,"end-line","end-line",1837326455),173,new cljs.core.Keyword(null,"column","column",2078222095),7,new cljs.core.Keyword(null,"line","line",212345235),158,new cljs.core.Keyword(null,"file","file",-1269645878),"/Users/brentvatne/coding/*live apps/red-eyes/app/assets/clojurescripts/target/cljsbuild-compiler-1/om_tools/core.cljs"], null)));
} else {
return null;
}
});

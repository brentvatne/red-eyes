...
goog.provide('redeyes.helpers');
goog.require('cljs.core');
goog.require('om_tools.dom');
redeyes.helpers.input_with_addons = (function input_with_addons(opts,input){
...
redeyes.helpers.button = (function button(opts,text){
...
* @param {...*} var_args
*/
redeyes.helpers.button_group = (function() { 
...
button_group.cljs$lang$applyTo = (function (arglist__19141){
var buttons = cljs.core.seq(arglist__19141);
...
* @param {...*} var_args
*/
redeyes.helpers.css_classes = (function() { 
...
css_classes.cljs$lang$applyTo = (function (arglist__19142){
var classes = cljs.core.seq(arglist__19142);
...
;
redeyes.helpers.active_QMARK_ = (function active_QMARK_(app){
return cljs.core._EQ_.call(null,true,cljs.core.get.call(null,app,"active"));
});
redeyes.helpers.log = (function log(msg){
return console.log(msg);
});
redeyes.helpers.log_clj = (function log_clj(obj){
return redeyes.helpers.log.call(null,cljs.core.clj__GT_js.call(null,obj));
});

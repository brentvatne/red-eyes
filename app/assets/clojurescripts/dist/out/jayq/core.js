...
G__5386.cljs$core$IFn$_invoke$arity$2 = G__5386__2;
G__5386.cljs$core$IFn$_invoke$arity$3 = G__5386__3;
return G__5386;
})()
;

jQuery.prototype.apply = (function (self__,args5385){
var self____$1 = this;
...
var hide__delegate = function ($elem,p__5387){
var vec__5389 = p__5387;
var speed = cljs.core.nth.call(null,vec__5389,(0),null);
var on_finish = cljs.core.nth.call(null,vec__5389,(1),null);
return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__5387 = null;
if (arguments.length > 1) {
  p__5387 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return hide__delegate.call(this,$elem,p__5387);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__5390){
var $elem = cljs.core.first(arglist__5390);
var p__5387 = cljs.core.rest(arglist__5390);
return hide__delegate($elem,p__5387);
});
...
var show__delegate = function ($elem,p__5391){
var vec__5393 = p__5391;
var speed = cljs.core.nth.call(null,vec__5393,(0),null);
var on_finish = cljs.core.nth.call(null,vec__5393,(1),null);
return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__5391 = null;
if (arguments.length > 1) {
  p__5391 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return show__delegate.call(this,$elem,p__5391);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__5394){
var $elem = cljs.core.first(arglist__5394);
var p__5391 = cljs.core.rest(arglist__5394);
return show__delegate($elem,p__5391);
});
...
var toggle__delegate = function ($elem,p__5395){
var vec__5397 = p__5395;
var speed = cljs.core.nth.call(null,vec__5397,(0),null);
var on_finish = cljs.core.nth.call(null,vec__5397,(1),null);
return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__5395 = null;
if (arguments.length > 1) {
  p__5395 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return toggle__delegate.call(this,$elem,p__5395);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__5398){
var $elem = cljs.core.first(arglist__5398);
var p__5395 = cljs.core.rest(arglist__5398);
return toggle__delegate($elem,p__5395);
});
...
var fade_out__delegate = function ($elem,p__5399){
var vec__5401 = p__5399;
var speed = cljs.core.nth.call(null,vec__5401,(0),null);
var on_finish = cljs.core.nth.call(null,vec__5401,(1),null);
return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__5399 = null;
if (arguments.length > 1) {
  p__5399 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_out__delegate.call(this,$elem,p__5399);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__5402){
var $elem = cljs.core.first(arglist__5402);
var p__5399 = cljs.core.rest(arglist__5402);
return fade_out__delegate($elem,p__5399);
});
...
var fade_in__delegate = function ($elem,p__5403){
var vec__5405 = p__5403;
var speed = cljs.core.nth.call(null,vec__5405,(0),null);
var on_finish = cljs.core.nth.call(null,vec__5405,(1),null);
return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__5403 = null;
if (arguments.length > 1) {
  p__5403 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_in__delegate.call(this,$elem,p__5403);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__5406){
var $elem = cljs.core.first(arglist__5406);
var p__5403 = cljs.core.rest(arglist__5406);
return fade_in__delegate($elem,p__5403);
});
...
var slide_up__delegate = function ($elem,p__5407){
var vec__5409 = p__5407;
var speed = cljs.core.nth.call(null,vec__5409,(0),null);
var on_finish = cljs.core.nth.call(null,vec__5409,(1),null);
...
return slide_up__delegate.call(this,$elem,p__5407);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__5410){
var $elem = cljs.core.first(arglist__5410);
var p__5407 = cljs.core.rest(arglist__5410);
return slide_up__delegate($elem,p__5407);
});
...
var slide_down__delegate = function ($elem,p__5411){
var vec__5413 = p__5411;
var speed = cljs.core.nth.call(null,vec__5413,(0),null);
var on_finish = cljs.core.nth.call(null,vec__5413,(1),null);
return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__5411 = null;
if (arguments.length > 1) {
  p__5411 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_down__delegate.call(this,$elem,p__5411);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__5414){
var $elem = cljs.core.first(arglist__5414);
var p__5411 = cljs.core.rest(arglist__5414);
return slide_down__delegate($elem,p__5411);
});
...
var closest__delegate = function ($elem,selector,p__5415){
var vec__5417 = p__5415;
var context = cljs.core.nth.call(null,vec__5417,(0),null);
return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__5415 = null;
if (arguments.length > 2) {
  p__5415 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return closest__delegate.call(this,$elem,selector,p__5415);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__5418){
var $elem = cljs.core.first(arglist__5418);
arglist__5418 = cljs.core.next(arglist__5418);
var selector = cljs.core.first(arglist__5418);
var p__5415 = cljs.core.rest(arglist__5418);
return closest__delegate($elem,selector,p__5415);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__5421){
var map__5423 = p__5421;
var map__5423__$1 = ((cljs.core.seq_QMARK_.call(null,map__5423))?cljs.core.apply.call(null,cljs.core.hash_map,map__5423):map__5423);
var request = map__5423__$1;
var contentType = cljs.core.get.call(null,map__5423__$1,new cljs.core.Keyword(null,"contentType","contentType",-1462509576));
var data = cljs.core.get.call(null,map__5423__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var ct = jayq.core.__GT_content_type.call(null,contentType);
return ((function (ct,map__5423,map__5423__$1,request,contentType,data){
return (function (p1__5420_SHARP_){
...
return cljs.core.assoc.call(null,p1__5420_SHARP_,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.pr_str.call(null,data));
} else {
return p1__5420_SHARP_;
}
});})(ct,map__5423,map__5423__$1,request,contentType,data))
.call(null,((function (ct,map__5423,map__5423__$1,request,contentType,data){
return (function (p1__5419_SHARP_){
if(cljs.core.truth_(ct)){
return cljs.core.assoc.call(null,p1__5419_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",-1462509576),ct);
} else {
...
;
jayq.core.xhr = (function xhr(p__5424,content,callback){
var vec__5426 = p__5424;
var method = cljs.core.nth.call(null,vec__5426,(0),null);
var uri = cljs.core.nth.call(null,vec__5426,(1),null);
...
var unbind__delegate = function ($elem,ev,p__5427){
var vec__5429 = p__5427;
var func = cljs.core.nth.call(null,vec__5429,(0),null);
return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__5427 = null;
if (arguments.length > 2) {
  p__5427 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return unbind__delegate.call(this,$elem,ev,p__5427);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__5430){
var $elem = cljs.core.first(arglist__5430);
arglist__5430 = cljs.core.next(arglist__5430);
var ev = cljs.core.first(arglist__5430);
var p__5427 = cljs.core.rest(arglist__5430);
return unbind__delegate($elem,ev,p__5427);
});
...
var on__delegate = function ($elem,events,p__5431){
var vec__5433 = p__5431;
var sel = cljs.core.nth.call(null,vec__5433,(0),null);
var data = cljs.core.nth.call(null,vec__5433,(1),null);
var handler = cljs.core.nth.call(null,vec__5433,(2),null);
return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__5431 = null;
if (arguments.length > 2) {
  p__5431 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return on__delegate.call(this,$elem,events,p__5431);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__5434){
var $elem = cljs.core.first(arglist__5434);
arglist__5434 = cljs.core.next(arglist__5434);
var events = cljs.core.first(arglist__5434);
var p__5431 = cljs.core.rest(arglist__5434);
return on__delegate($elem,events,p__5431);
});
...
var one__delegate = function ($elem,events,p__5435){
var vec__5437 = p__5435;
var sel = cljs.core.nth.call(null,vec__5437,(0),null);
var data = cljs.core.nth.call(null,vec__5437,(1),null);
var handler = cljs.core.nth.call(null,vec__5437,(2),null);
return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__5435 = null;
if (arguments.length > 2) {
  p__5435 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return one__delegate.call(this,$elem,events,p__5435);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__5438){
var $elem = cljs.core.first(arglist__5438);
arglist__5438 = cljs.core.next(arglist__5438);
var events = cljs.core.first(arglist__5438);
var p__5435 = cljs.core.rest(arglist__5438);
return one__delegate($elem,events,p__5435);
});
...
var off__delegate = function ($elem,events,p__5439){
var vec__5441 = p__5439;
var sel = cljs.core.nth.call(null,vec__5441,(0),null);
var handler = cljs.core.nth.call(null,vec__5441,(1),null);
return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__5439 = null;
if (arguments.length > 2) {
  p__5439 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return off__delegate.call(this,$elem,events,p__5439);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__5442){
var $elem = cljs.core.first(arglist__5442);
arglist__5442 = cljs.core.next(arglist__5442);
var events = cljs.core.first(arglist__5442);
var p__5439 = cljs.core.rest(arglist__5442);
return off__delegate($elem,events,p__5439);
});
...
done.cljs$lang$applyTo = (function (arglist__5443){
var deferred = cljs.core.first(arglist__5443);
var fns_args = cljs.core.rest(arglist__5443);
...
fail.cljs$lang$applyTo = (function (arglist__5444){
var deferred = cljs.core.first(arglist__5444);
var fns_args = cljs.core.rest(arglist__5444);
...
always.cljs$lang$applyTo = (function (arglist__5445){
var deferred = cljs.core.first(arglist__5445);
var fns_args = cljs.core.rest(arglist__5445);

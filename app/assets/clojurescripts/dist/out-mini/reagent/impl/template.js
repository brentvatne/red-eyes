...
var or__3638__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__5436 = o;
(G__5436[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5437){
var vec__5439 = p__5437;
var id = cljs.core.nth.call(null,vec__5439,(0),null);
var class$ = cljs.core.nth.call(null,vec__5439,(1),null);
var pid = (props["id"]);
...
var pname_5440 = reagent.impl.template.cached_prop_name.call(null,k);
if(!((pname_5440 === "key"))){
(o[pname_5440] = reagent.impl.template.convert_prop_value.call(null,v));
} else {
}
...
var G__5443 = jsprops;
(G__5443["defaultValue"] = value);

(G__5443["value"] = null);

(G__5443["onChange"] = ((function (G__5443,on_change,value){
return (function (p1__5441_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5441_SHARP_);
});})(G__5443,on_change,value))
);
...
var or__3638__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__3638__auto__)){
return or__3638__auto__;
} else {
var a1 = (c["props"]["argv"]);
...
var G__5445 = spec;
(G__5445["componentDidUpdate"] = ((function (G__5445){
return (function (){
var c = this;
...
(G__5445["componentWillUnmount"] = ((function (G__5445){
return (function (){
var c = this;
...
var spec = {"displayName": (function (){var or__3638__auto__ = name;
if(cljs.core.truth_(or__3638__auto__)){
return or__3638__auto__;
} else {
...
return (function (p1__5446_SHARP_,p2__5447_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update.call(null,C,p1__5446_SHARP_,p2__5447_SHARP_);
...
var vec__5449 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5449,(0),null);
var id = cljs.core.nth.call(null,vec__5449,(1),null);
var class$ = cljs.core.nth.call(null,vec__5449,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3638__auto__ = id;
if(cljs.core.truth_(or__3638__auto__)){
return or__3638__auto__;
} else {
...
var vec__5451 = reagent.impl.template.parse_tag.call(null,tag);
var comp = cljs.core.nth.call(null,vec__5451,(0),null);
var id_class = cljs.core.nth.call(null,vec__5451,(1),null);
...
var k_5452 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
var k_SINGLEQUOTE__5453 = (((k_5452 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5452);
if((k_SINGLEQUOTE__5453 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__5453);
}
...
var n__4525__auto___5454 = a.length;
var i_5455 = (0);
while(true){
if((i_5455 < n__4525__auto___5454)){
(a[i_5455] = reagent.impl.template.as_component.call(null,(a[i_5455]),level_SINGLEQUOTE_));

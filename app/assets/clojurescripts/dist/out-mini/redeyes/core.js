...
css_classes.cljs$lang$applyTo = (function (arglist__6472){
var classes = cljs.core.seq(arglist__6472);
...
redeyes.core.update_app = (function update_app(app,opts){
return cljs.core.swap_BANG_.call(null,redeyes.core.data,cljs.core.replace,cljs.core.map.call(null,(function (this_app){
if(cljs.core._EQ_.call(null,this_app,app)){
return cljs.core.merge.call(null,app,opts);
} else {
return cljs.core.identity.call(null,this_app);
}
}),cljs.core.deref.call(null,redeyes.core.data)));
});
redeyes.core.activate = (function activate(app){
redeyes.core.update_app.call(null,app,new cljs.core.PersistentArrayMap(null, 1, ["active",true], null));

return redeyes.api.persist_active_status.call(null,app);
});
redeyes.core.deactivate = (function deactivate(app){
redeyes.core.update_app.call(null,app,new cljs.core.PersistentArrayMap(null, 1, ["active",false], null));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"form-group"], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"input-group"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"input-group-addon"], null),"http://"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,value),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"URL here please!",new cljs.core.Keyword(null,"class","class",-2030961996),"form-control",new cljs.core.Keyword(null,"id","id",-1388402092),"sleepy-app-url",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__6473_SHARP_){
return cljs.core.reset_BANG_.call(null,value,p1__6473_SHARP_.target.value);
...
return (function iter__6478(s__6479){
return (new cljs.core.LazySeq(null,((function (apps){
return (function (){
var s__6479__$1 = s__6479;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__6479__$1);
if(temp__4126__auto__){
var s__6479__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__6479__$2)){
var c__4392__auto__ = cljs.core.chunk_first.call(null,s__6479__$2);
var size__4393__auto__ = cljs.core.count.call(null,c__4392__auto__);
var b__6481 = cljs.core.chunk_buffer.call(null,size__4393__auto__);
if((function (){var i__6480 = (0);
while(true){
if((i__6480 < size__4393__auto__)){
var app = cljs.core._nth.call(null,c__4392__auto__,i__6480);
cljs.core.chunk_append.call(null,b__6481,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [redeyes.core.sleepy_app,app], null));

var G__6482 = (i__6480 + (1));
i__6480 = G__6482;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__6481),iter__6478.call(null,cljs.core.chunk_rest.call(null,s__6479__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__6481),null);
}
} else {
var app = cljs.core.first.call(null,s__6479__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [redeyes.core.sleepy_app,app], null),iter__6478.call(null,cljs.core.rest.call(null,s__6479__$2)));
}
} else {
return null;
}
